        ...
        <div className="mb-4 flex flex-col sm:flex-row items-center justify-start gap-4">
          <div className="relative w-full max-w-sm">
              ...
              <input
                  ...
                  className="block w-full pl-11 pr-10 py-2 border border-slate-300 bg-white rounded-full shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-teal-500 sm:text-sm"
              />
          ...
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="relative p-2 rounded-full text-slate-600 hover:bg-slate-100 hover:text-slate-800 focus:outline-none focus:ring-2 focus:ring-teal-500"
